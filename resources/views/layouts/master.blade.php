...
<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            ...
            <img class="hidden-lg-up" src="{{asset('startui/img/logo-2-mob.png')}}" alt="">
        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
                            ...
                            <div class="dropdown-menu-notif-list">
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{asset('startui/img/photo-64-1.jpg')}}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{asset('startui/img/photo-64-3.jpg')}}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{asset('startui/img/photo-64-4.jpg')}}" alt="">
                                    </div>
                                ...
                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                                    <div class="dropdown-menu-messages-list">
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img src="{{asset('startui/img/photo-64-2.jpg')}}" alt=""></span>
                                            <span class="mess-item-name">Tim Collins</span>
                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
                                        </a>
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img src="{{asset('startui/img/avatar-2-64.png')}}" alt=""></span>
...
<nav class="side-menu">
    <ul class="side-menu-list">
        ...
        <li class="magenta">
            <a href="{{url('/municipalities')}}">
                <span class="glyphicon glyphicon-th"></span>
                <span class="lbl">VDC/Municipality</span>
            </a>
        </li>
    </ul>
